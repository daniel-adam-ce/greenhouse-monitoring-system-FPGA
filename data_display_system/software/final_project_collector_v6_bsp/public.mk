...
# setting SOPC_SYSID_BASE_ADDRESS is 0x20f0
SOPC_SYSID_FLAG += --sidp=0x20f0
ELF_PATCH_FLAG  += --sidp 0x20f0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1638321776
SOPC_SYSID_FLAG += --timestamp=1638321776
ELF_PATCH_FLAG  += --timestamp 1638321776
